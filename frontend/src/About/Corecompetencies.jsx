...
const COMPETENCIES = [
  {
    ...
    subtitle: "MERN Stack",
    desc: "Building end-to-end web applications with MongoDB, Express, React, and Node.js. Focused on clean architecture and performance.",
    accent: "#2563eb",
  ...
  },
  {
    ...
    desc: "Creating responsive, attractive, and user-friendly interfaces with modern CSS and design principles for great user experiences.",
    accent: "#0ea5e9",
    tags: ["Tailwind CSS", "Figma","PhotoShop", "Responsive Design"],
  },
  {
    icon: "🔧",
    title: "Backend & API Development",
    subtitle: "Server & Database",
    desc: "RESTful API design, server-side logic, authentication systems, and efficient database management for scalable applications.",
    accent: "#10b981",
    tags: ["REST APIs", "JWT", "PostgreSQL", "MongoDB","Express"],
  },
  {
    icon: "📦",
    title: "Version Control & Collaboration",
    subtitle: "Git & Teamwork",
    desc: "Proficient in Git workflows, GitHub collaboration, open source contributions, and maintaining clean codebases in team environments.",
    accent: "#f59e0b",
    tags: ["Git", "GitHub", "Open Source", "Code Review"],
  },
  {
    icon: "🧠",
    title: "Data Structures & Algorithms",
    subtitle: "Problem Solving",
    desc: "Strong foundation in problem-solving, algorithmic thinking, optimization techniques, and coding efficiency for production-grade applications.",
    accent: "#8b5cf6",
    tags: ["DSA", "Optimization", "JavaScript", "Logic"],
  },
  {
    icon: "🚀",
    title: "Project Management & Agile",
    subtitle: "Planning & Execution",
    desc: "Task planning, sprint management, milestone tracking, and hands-on hackathon experience for delivering projects on time.",
    accent: "#ef4444",
    tags: ["Agile", "Scrum", "Hackathons", "Planning"],
  },
];
